...
public class AgentsMissingFromProdAndNonProdEnvironments extends RemoteReport {
    ...
    protected ReportOutput reportScript(ReportMetaData metaData) throws Exception {
        ...
        String query = "select id, host, name, last_start_time from agent a\n" +
                ...
                "    select id from server_group where name like '%All non-prod%' or name like '%ALL PRODUCTION%'\n" +
                "  )\n" +
                ")\n" +
                "and a.isdeleted = 0\n" +
                "and a.isignored = 0\n" +
