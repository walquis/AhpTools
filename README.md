...
# --agent can be a comma-separated list.  The environment named in --env must already exist.
#
C:\AhpTools> jruby commands/bin/add_agents  --agent energyclerk1 --env 'All Production Agents'
